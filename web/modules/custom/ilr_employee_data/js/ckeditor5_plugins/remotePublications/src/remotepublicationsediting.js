...
import InsertRemotePublicationsCommand from './insertremotepublicationscommand';

// cSpell:ignore simplebox insertRemotePublicationscommand
 ...
 */
export default class RemotePublicationsEditing extends Plugin {
  static get requires() {
    return [Widget];
  }
  ...
  init() {
    ...
    this.editor.commands.add(
      'insertRemotePublications',
      new InsertRemotePublicationsCommand(this.editor),
    );
  }
  ...
  _defineSchema() {
    ...
    // block element.
    this.editor.editing.view.domConverter.blockElements.push('ilr-publications');
  }
