/**
 * @file defines InsertRemotePublicationsCommand, which is executed when the simpleBox
...
export default class InsertRemotePublicationsCommand extends Command {
  execute() {
    ...
    model.change((writer) => {
      ...
      model.insertContent(createRemotePublications(writer));
    });
  }
...
function createRemotePublications(writer) {
