...
class CollectionContextTermSelectionBase extends SelectionPluginBase implements ContainerFactoryPluginInterface {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    ...
    $instance->collectionResourceLibraryManager = $container->get('collection_resource_library.manager');
    return $instance;
  }
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['collection_context']['help'] = [
      '#markup' => '<p>' . $this->t('Uses the collection context to determine which resource library research topic terms should be referenced.') . '</p>',
    ];
  ...
  public function getReferenceableEntities($match = NULL, $match_operator = 'CONTAINS', $limit = 0) {
    ...
    $vocabulary = $this->collectionResourceLibraryManager->getCollectedVocabularyByKey($configuration['entity']->collection->entity, $this->identifier);
