...
namespace Drupal\ilr\Entity\Handler;
...
/**
 * Customizations for term entities.
 *
 * @see Drupal\content_moderation\EntityTypeInfo::addModerationToEntityType().
 * @see ilr_entity_type_alter().
 */
class TermModerationHandler extends ModerationHandler {
