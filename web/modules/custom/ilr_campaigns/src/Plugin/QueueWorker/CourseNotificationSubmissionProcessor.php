 ...
 *
 * @QueueWorker(
 *   id = "course_notification_submission_processor",
 *   title = @Translation("Course Notification Subscriber"),
 *   cron = {"time" = 90}
 * )
 */
class CourseNotificationSubmissionProcessor extends QueueWorkerBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a CourseNotificationSubmissionProcessor queue object.
   *
